...
**Architecture:** 2 campaigns × 2 markets (`CORE` + `ROLES`) · Brand deferred for Stage 1. **Zoho + offline conversions deferred during cold start** (not cancelled) — [ZOHO-COLD-START-DEFERRED-2026-08-14.md](./ZOHO-COLD-START-DEFERRED-2026-08-14.md). Medium planning exception 13 Aug: [US Brand Defense](./BRAND-US-DEFENSE-AUDIT-2026-08-13.md) — Paused CSV only; do not Enable.
