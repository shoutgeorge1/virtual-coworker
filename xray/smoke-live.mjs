...
const checks = [
  {
    ...
    require: [/Executive Performance/i, /United States/i, /Australia/i, /What leadership needs to know/i, /Market scorecards/i, /Pilot vs recorded legacy baseline/i, /Data confidence/i, /Budget/i, /Key blockers/i],
