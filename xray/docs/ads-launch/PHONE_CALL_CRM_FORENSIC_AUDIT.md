...
| What historical data is missing? | **6–18 Aug US** provider call logs; pre-divert 310 path; full AU inbound history; decrypted Voice export row-level stats (zip exists in Gmail, not ingested here). | UNAVAILABLE |
...
| Unique callers / answered / missed / VM | **UNAVAILABLE** until Voice ingest |
