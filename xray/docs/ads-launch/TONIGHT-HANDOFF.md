...
2. **Import vs Post** documented in `DECISIONS.md` + Launch Control step 6 — Import = local draft; Post = live upload; `VC_*` add alongside `PM_*`.
...
- `xray/launch-control.html` — step 6 import copy · Waiting for George · Later Zoho offline
