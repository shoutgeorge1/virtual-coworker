...
export const TRUST_FIRST_PAGES: Record<TrustFirstPageKey, TrustFirstPageConfig> = {
  ...
  "real-estate": page({
    ...
    keywordCluster:
      "assistant property manager / guest relations / property bookkeeper / real estate EA / dedicated lead generation",
    intendedCampaign: "VC_US_S_ROLES (proposed, paused)",
    intendedAdGroup: "RE_Ops_Hire_PH (proposed, paused). Do not bid generic Real Estate VA.",
    title: "Hire Property and Real Estate Staff | Virtual Coworker",
    description:
      "Hire dedicated Philippines staff for US property managers and real-estate operators. Assistant property managers, guest relations, lead generation, bookkeeping, and executive support.",
    eyebrow: "For property managers and real-estate operators",
    h1: "Hire dedicated staff for property and real-estate operations",
    supporting:
      "Assistant property managers, guest relations, lead generation, bookkeeping, and executive support. Dedicated headcount so you can stay on sales and strategy. You interview. Not a cold-calling desk and not a lead-buying service.",
    heroBullets: [
      "Dedicated seat, not task scraps",
      "Supported ops roles only",
    ...
    roles: [
      { title: "Assistant Property Manager", body: "Day-to-day property operations owned by one dedicated person." },
      { title: "Guest Relations Specialist", body: "Guest messages, stays, and follow-through." },
      { title: "Lead Generation", body: "A dedicated lead-generation seat. Not pay-per-lead. Not a lead-buying platform." },
      { title: "Bookkeeper", body: "Invoices, records, and reconciliations for the books." },
      { title: "Executive Assistant", body: "Inbox, calendar, and coordination so operators get time back." },
    ],
    faqs: [
      {
        q: "Do you staff real estate cold callers or ISAs?",
        a: "No. We stopped that work because retention was poor. This page is for dedicated operations seats, not outbound prospecting for agents.",
      },
      {
        q: "Is this a lead-buying service?",
        a: "No. Virtual Coworker is a staffing company. Lead generation here means a dedicated person on your team, not pay-per-lead or cost-per-acquisition pricing.",
      },
      {
        q: "Do they replace a licensed agent?",
        a: "No. They take the remote operations work so licensed people can stay on clients and closings.",
      },
      ...SHARED_FAQS.slice(1),
    ],
    ...
    jobSeekerRisk: "low",
    pageKind: "existing-challenger",
    recommendedStatus: "Align with live /us/real-estate. Do not point ads until George enables the paused Editor file.",
    notes: "Keep generic Real Estate VA, ISA, and cold-call out of the H1. Supported seats only.",
    confidence: "medium",
  }),
