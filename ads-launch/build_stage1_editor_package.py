...
CORE_EXACT_BY_AG: dict[str, list[str]] = {
    "Hire_VA_PH": [
        ...
        # Agency-hire intent Exact adds (2026-08-09) — employer seeking agency/firm/company
        "virtual assistant firm",
        "va firm",
        "virtual staffing agency",
        "virtual staffing firm",
    ...
    "Offshore_VA_PH": [
        ...
        # Agency-hire intent Exact adds (2026-08-09) — PH/Filipino/offshore agency seekers
        ...
        "philippines va firm",
        "virtual assistant firm philippines",
